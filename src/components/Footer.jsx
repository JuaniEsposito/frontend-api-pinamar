          ...
          <div>
            ...
            <div className="flex gap-2 mt-2">
              ...
              <a href="#" aria-label="Facebook" className="bg-blue-200 rounded-full w-7 h-7 flex items-center justify-center text-lg hover:bg-blue-600 hover:text-white transition">
                <svg fill="#ffff" viewBox="0 0 24 24" className="w-4 h-4">
                  <path d="M22.675 0h-21.35C.595 0 0 .592 0 1.326v21.348C0 23.408.595 24 1.325 24h11.495v-9.294H9.692v-3.622h3.128V8.413c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.463.099 2.797.143v3.24l-1.918.001c-1.504 0-1.797.715-1.797 1.763v2.313h3.587l-.467 3.622h-3.12V24h6.116C23.406 24 24 23.408 24 22.674V1.326C24 .592 23.406 0 22.675 0"/>
                </svg>
              </a>
              {/* Instagram */}
              <a href="#" aria-label="Instagram" className="bg-orange-200 rounded-full w-7 h-7 flex items-center justify-center text-lg hover:bg-gradient-to-tr hover:from-pink-500 hover:to-yellow-400 hover:text-white transition">
                <svg fill="#ffff" viewBox="0 0 24 24" className="w-4 h-4">
              ...
              {/* YouTube */}
              <a href="#" aria-label="YouTube" className="bg-red-200 rounded-full w-7 h-7 flex items-center justify-center text-lg hover:bg-red-600 hover:text-white transition">
                <svg fill="#ffff" viewBox="0 0 24 24" className="w-4 h-4">
              ...
              {/* TikTok */}
              <a href="#" aria-label="TikTok" className="bg-pink-200 rounded-full w-7 h-7 flex items-center justify-center text-lg hover:bg-black hover:text-white transition">
                <svg fill="#ffff" viewBox="0 0 24 24" className="w-4 h-4">
            ...
            <div className="flex gap-2 mt-2">
              {/* Visa */}
              <span className="bg-green-200 rounded w-10 h-6 flex items-center justify-center text-xs">
              ...
              <span className="bg-green-200 rounded w-10 h-6 flex items-center justify-center text-xs">
                <svg viewBox="0 0 32 12" width="32" height="12">
                  ...
                  <text x="5" y="11" fontFamily="Arial" fontWeight="bold" fontSize="7" fill="#000">MC</text>
                </svg>
              </span>
              {/* Amex */}
              <span className="bg-green-200 rounded w-10 h-6 flex items-center justify-center text-xs">
