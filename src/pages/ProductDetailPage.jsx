...
const destacados = [
  {
    ...
    bestSeller: true,
    description:
      "Manzanas frescas seleccionadas, ideales para consumir solas o en postres. Cultivadas en el Alto Valle de Río Negro.",
    category: "Verdulería",
    subcategory: "Frutas",
    stock: 25,
  ...
  },
  {
    ...
    bestSeller: false,
    description:
      "Leche entera de primera calidad, fuente de calcio y vitaminas. Ideal para toda la familia.",
    category: "Lácteos",
    subcategory: "Leche",
    stock: 40,
  ...
  },
  {
    ...
    bestSeller: false,
    description:
      "Pan integral rico en fibras, ideal para una alimentación saludable.",
    category: "Panadería",
    subcategory: "Pan",
    stock: 12,
  ...
  },
  {
    ...
    bestSeller: true,
    description:
      "Corte premium de carne vacuna, tierno y sabroso. Ideal para la parrilla.",
    category: "Carnes",
    subcategory: "Vacuna",
    stock: 8,
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: 400,
          background:
            "radial-gradient(ellipse at center, #fff 60%, #e0e7ff 100%)",
          zIndex: 1,
        }}
      />
      <div className="relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          {/* Info principal */}
          <div className="flex-1 flex flex-col gap-2">
            <h1 className="text-3xl font-bold mb-1 text-primary drop-shadow-sm">
              {nombre}
            </h1>
            ...
            <div className="text-2xl font-bold text-primary mb-2 drop-shadow">
              ${precio}
            </div>
            <div className="text-xs text-gray-400 mb-2">
              Precio sin impuestos nacionales: $
              {precio ? Math.round(precio / 1.21) : 0}
            </div>
            <div className="mb-2 text-gray-700">{descripcion}</div>
            <div className="flex items-center gap-4 mb-4">
              <span
                className={`text-sm font-medium ${
                  stock > 5 ? "text-secondary" : "text-red-500"
                }`}
              >
              ...
              {origen && (
                <span className="text-xs text-gray-400">Origen: {origen}</span>
              )}
            </div>
            {/* Cantidad y agregar */}
            <div className="flex items-center gap-3 mb-4 relative">
              ...
              {units > 0 && (
                <span className="absolute right-0 bottom-0 bg-[#6DB33F]-100 text-[#6DB33F]-700 text-xs px-2 py-0.5 rounded-full font-bold pointer-events-none">
                  x{units}
                </span>
              )}
              {addCartMsg && (
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
            ...
            <ul className="text-gray-700 text-base space-y-2">
              <li>
                <span className="font-semibold">Marca:</span> {marca}
              </li>
              <li>
                <span className="font-semibold">Peso/Contenido:</span> {peso}
              </li>
              {categoriaNombre && (
                <li>
